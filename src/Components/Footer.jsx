...
<Link to='https://www.facebook.com/share/176CqcbK7x/' >
        ...
        {/* Bottom section */}
        <div className="flex flex-col hidden md:block lg:flex-row justify-between items-center pt-8 mt-8 border-t border-gray-300">
          <p className="text-lg text-blue-100">This product  and its certificate are not challengeable in any court of law.</p>
           ...
           <div className="flex block md:hidden flex-col lg:flex-row justify-start items-start pt-8 mt-8 border-t border-gray-300">
          <p className="text-lg text-blue-100">This product  and its certificate are not challengeable in any court of law.</p>
           <p className="text-lg mr-3  text-blue-100">Made in Pakistan</p>
